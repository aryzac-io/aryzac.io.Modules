...
export class ClientsService {
  public async changeNameClientCommand(
    id: string,
  ...
  public async changeNoteClientCommand(
    id: string,
    command: ChangeNoteClientCommand
  ): Promise<AsyncData<any, any>> {
    const config = useRuntimeConfig();
  ...
  public async changeReceivePromotionClientCommand(
    id: string,
    command: ChangeReceivePromotionClientCommand
  ): Promise<AsyncData<any, any>> {
    const config = useRuntimeConfig();
  ...
  public async changeTitleClientCommand(
    id: string,
    command: ChangeTitleClientCommand
  ): Promise<AsyncData<any, any>> {
    const config = useRuntimeConfig();
  ...
  public async createClientCommand(
  ...
  public async getClientByIdQuery(
    id: string
