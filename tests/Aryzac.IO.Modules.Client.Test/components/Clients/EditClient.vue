...
import { useEditClientNewLabelOptions } from '~/composables/components//Clients/EditClient/useEditClientNewLabelOptions'
...
const newLabelOptions = await useEditClientNewLabelOptions(props, model);
