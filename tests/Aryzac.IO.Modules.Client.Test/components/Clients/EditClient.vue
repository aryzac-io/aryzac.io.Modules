...
watchEffect(async () => {
  if (editClientGetClientByIdQueryData.value) {
    ...
    model.receivePromotions =
      editClientGetClientByIdQueryData.value.receivePromotions;
...
const changeTitleClientCommand = async () => {
  ...
  const changeTitleClientCommand =
    await clientsServiceProxy.changeTitleClientCommand(id, command);
};
const changeReceivePromotionClientCommand = async () => {
  ...
  const changeReceivePromotionClientCommand =
    await clientsServiceProxy.changeReceivePromotionClientCommand(id, command);
};
const changeNoteClientCommand = async () => {
  ...
  const changeNoteClientCommand =
    await clientsServiceProxy.changeNoteClientCommand(id, command);
};
...
<template>
  ...
  >
    <ui-input-text-area v-model="model.notes" :label="t('notes.notes.label')" />
