...
namespace Aryzac.IO.Modules.Client.Test.Api.Application.Clients.ChangeTitleClient
{
    ...
    public class ChangeTitleClientCommandHandler : IRequestHandler<ChangeTitleClientCommand>
    {
        private readonly IClientRepository _clientRepository;

        [IntentManaged(Mode.Merge)]
        public ChangeTitleClientCommandHandler(IClientRepository clientRepository)
        {
            _clientRepository = clientRepository;
        }

        [IntentManaged(Mode.Fully, Body = Mode.Fully)]
        public async Task Handle(ChangeTitleClientCommand request, CancellationToken cancellationToken)
        {
            ...
            client.ChangeTitle(request.TitleId);
        }
    }
}