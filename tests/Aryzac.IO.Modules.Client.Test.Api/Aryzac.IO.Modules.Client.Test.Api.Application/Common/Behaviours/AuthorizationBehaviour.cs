...
using Aryzac.IO.Modules.Client.Test.Api.Application.Common.Exceptions;
using Aryzac.IO.Modules.Client.Test.Api.Application.Common.Interfaces;
using Aryzac.IO.Modules.Client.Test.Api.Application.Common.Security;
...
namespace Aryzac.IO.Modules.Client.Test.Api.Application.Common.Behaviours
{
