...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    public class CardModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasTypeReference
    {
        public const string SpecializationType = "Card";
        public const string SpecializationTypeId = "86e91725-f6c0-41ef-baea-353bdce84252";
