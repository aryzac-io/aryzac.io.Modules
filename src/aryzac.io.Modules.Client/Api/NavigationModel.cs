...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    public class NavigationModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasTypeReference
    {
        public const string SpecializationType = "Navigation";
        public const string SpecializationTypeId = "e9c6d81b-1204-468b-889e-9490f37c223f";
