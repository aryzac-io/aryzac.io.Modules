...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    public class CommandModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper
    {
        public const string SpecializationType = "Command";
        public const string SpecializationTypeId = "4a186cc2-552b-4438-89ff-02642035a61a";
