...
{
    public static class ToolbarModelStereotypeExtensions
    {
        public static Align GetAlign(this ToolbarModel model)
        {
        ...
        public static bool HasAlign(this ToolbarModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this ToolbarModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this ToolbarModel model)
        {
        ...
        public static bool HasFlex(this ToolbarModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this ToolbarModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this ToolbarModel model)
        {
        ...
        public static bool HasFlexAuto(this ToolbarModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this ToolbarModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this ToolbarModel model)
        {
        ...
        public static bool HasFlexColumns(this ToolbarModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this ToolbarModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this ToolbarModel model)
        {
        ...
        public static bool HasFlexGrow(this ToolbarModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this ToolbarModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this ToolbarModel model)
        {
        ...
        public static bool HasFlexInitial(this ToolbarModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this ToolbarModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this ToolbarModel model)
        {
        ...
        public static bool HasFlexNone(this ToolbarModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this ToolbarModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this ToolbarModel model)
        {
        ...
        public static bool HasFlexReverse(this ToolbarModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this ToolbarModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this ToolbarModel model)
        {
        ...
        public static bool HasFlexRow(this ToolbarModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this ToolbarModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this ToolbarModel model)
        {
        ...
        public static bool HasFlexShrink(this ToolbarModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this ToolbarModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this ToolbarModel model)
        {
        ...
        public static bool HasFlexWrap(this ToolbarModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this ToolbarModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this ToolbarModel model)
        {
        ...
        public static bool HasGap(this ToolbarModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this ToolbarModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this ToolbarModel model)
        {
        ...
        public static bool HasGapX(this ToolbarModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this ToolbarModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this ToolbarModel model)
        {
        ...
        public static bool HasGapY(this ToolbarModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this ToolbarModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this ToolbarModel model)
        {
        ...
        public static bool HasGrid(this ToolbarModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this ToolbarModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this ToolbarModel model)
        {
        ...
        public static bool HasGridColumnSpan(this ToolbarModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this ToolbarModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this ToolbarModel model)
        {
        ...
        public static bool HasGridColumns(this ToolbarModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this ToolbarModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this ToolbarModel model)
        {
        ...
        public static bool HasGridRowSpan(this ToolbarModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this ToolbarModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this ToolbarModel model)
        {
        ...
        public static bool HasGridRows(this ToolbarModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this ToolbarModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this ToolbarModel model)
        {
        ...
        public static bool HasJustify(this ToolbarModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this ToolbarModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this ToolbarModel model)
        {
        ...
        public static bool HasOrder(this ToolbarModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this ToolbarModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
