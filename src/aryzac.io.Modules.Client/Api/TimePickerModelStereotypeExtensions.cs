...
{
    public static class TimePickerModelStereotypeExtensions
    {
        public static Align GetAlign(this TimePickerModel model)
        {
        ...
        public static bool HasAlign(this TimePickerModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this TimePickerModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this TimePickerModel model)
        {
        ...
        public static bool HasFlex(this TimePickerModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this TimePickerModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this TimePickerModel model)
        {
        ...
        public static bool HasFlexAuto(this TimePickerModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this TimePickerModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this TimePickerModel model)
        {
        ...
        public static bool HasFlexColumns(this TimePickerModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this TimePickerModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this TimePickerModel model)
        {
        ...
        public static bool HasFlexGrow(this TimePickerModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this TimePickerModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this TimePickerModel model)
        {
        ...
        public static bool HasFlexInitial(this TimePickerModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this TimePickerModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this TimePickerModel model)
        {
        ...
        public static bool HasFlexNone(this TimePickerModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this TimePickerModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this TimePickerModel model)
        {
        ...
        public static bool HasFlexReverse(this TimePickerModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this TimePickerModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this TimePickerModel model)
        {
        ...
        public static bool HasFlexRow(this TimePickerModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this TimePickerModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this TimePickerModel model)
        {
        ...
        public static bool HasFlexShrink(this TimePickerModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this TimePickerModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this TimePickerModel model)
        {
        ...
        public static bool HasFlexWrap(this TimePickerModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this TimePickerModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this TimePickerModel model)
        {
        ...
        public static bool HasGap(this TimePickerModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this TimePickerModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this TimePickerModel model)
        {
        ...
        public static bool HasGapX(this TimePickerModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this TimePickerModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this TimePickerModel model)
        {
        ...
        public static bool HasGapY(this TimePickerModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this TimePickerModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this TimePickerModel model)
        {
        ...
        public static bool HasGrid(this TimePickerModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this TimePickerModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this TimePickerModel model)
        {
        ...
        public static bool HasGridColumnSpan(this TimePickerModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this TimePickerModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this TimePickerModel model)
        {
        ...
        public static bool HasGridColumns(this TimePickerModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this TimePickerModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this TimePickerModel model)
        {
        ...
        public static bool HasGridRowSpan(this TimePickerModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this TimePickerModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this TimePickerModel model)
        {
        ...
        public static bool HasGridRows(this TimePickerModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this TimePickerModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this TimePickerModel model)
        {
        ...
        public static bool HasJustify(this TimePickerModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this TimePickerModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this TimePickerModel model)
        {
        ...
        public static bool HasOrder(this TimePickerModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this TimePickerModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
