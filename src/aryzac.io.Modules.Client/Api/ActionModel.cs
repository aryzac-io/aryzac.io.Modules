...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    public class ActionModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasTypeReference
    {
        public const string SpecializationType = "Action";
        public const string SpecializationTypeId = "90af522a-f9b0-4cb4-a6b2-048910b98f6d";
