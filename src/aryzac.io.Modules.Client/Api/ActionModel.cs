...
namespace Aryzac.IO.Modules.Client.Api
{
    ...
    public class ActionModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper
    {
        public const string SpecializationType = "Action";
        public const string SpecializationTypeId = "420c5366-fd1b-4130-afab-45f4ece2cce2";
