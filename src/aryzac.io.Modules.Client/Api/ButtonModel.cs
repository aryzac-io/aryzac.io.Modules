...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    public class ButtonModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasTypeReference
    {
        public const string SpecializationType = "Button";
        public const string SpecializationTypeId = "cc2c518e-24c5-47b7-b1d7-3378a2d2a096";
