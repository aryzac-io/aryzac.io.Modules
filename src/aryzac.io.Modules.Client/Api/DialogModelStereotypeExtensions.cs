...
{
    public static class DialogModelStereotypeExtensions
    {
        public static Align GetAlign(this DialogModel model)
        {
        ...
        public static bool HasAlign(this DialogModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this DialogModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this DialogModel model)
        {
        ...
        public static bool HasFlex(this DialogModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this DialogModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this DialogModel model)
        {
        ...
        public static bool HasFlexAuto(this DialogModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this DialogModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this DialogModel model)
        {
        ...
        public static bool HasFlexColumns(this DialogModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this DialogModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this DialogModel model)
        {
        ...
        public static bool HasFlexGrow(this DialogModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this DialogModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this DialogModel model)
        {
        ...
        public static bool HasFlexInitial(this DialogModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this DialogModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this DialogModel model)
        {
        ...
        public static bool HasFlexNone(this DialogModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this DialogModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this DialogModel model)
        {
        ...
        public static bool HasFlexReverse(this DialogModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this DialogModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this DialogModel model)
        {
        ...
        public static bool HasFlexRow(this DialogModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this DialogModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this DialogModel model)
        {
        ...
        public static bool HasFlexShrink(this DialogModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this DialogModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this DialogModel model)
        {
        ...
        public static bool HasFlexWrap(this DialogModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this DialogModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this DialogModel model)
        {
        ...
        public static bool HasGap(this DialogModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this DialogModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this DialogModel model)
        {
        ...
        public static bool HasGapX(this DialogModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this DialogModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this DialogModel model)
        {
        ...
        public static bool HasGapY(this DialogModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this DialogModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this DialogModel model)
        {
        ...
        public static bool HasGrid(this DialogModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this DialogModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this DialogModel model)
        {
        ...
        public static bool HasGridColumnSpan(this DialogModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this DialogModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this DialogModel model)
        {
        ...
        public static bool HasGridColumns(this DialogModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this DialogModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this DialogModel model)
        {
        ...
        public static bool HasGridRowSpan(this DialogModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this DialogModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this DialogModel model)
        {
        ...
        public static bool HasGridRows(this DialogModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this DialogModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this DialogModel model)
        {
        ...
        public static bool HasJustify(this DialogModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this DialogModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this DialogModel model)
        {
        ...
        public static bool HasOrder(this DialogModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this DialogModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
