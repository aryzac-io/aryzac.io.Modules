...
namespace Aryzac.IO.Modules.Client.Api
{
    ...
    public class TextboxModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper
    {
        public const string SpecializationType = "Textbox";
        public const string SpecializationTypeId = "db535835-3d01-421d-9f29-206732782bfe";
