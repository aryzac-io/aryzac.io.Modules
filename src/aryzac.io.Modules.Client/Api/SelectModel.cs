...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    public class SelectModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasTypeReference
    {
        public const string SpecializationType = "Select";
        public const string SpecializationTypeId = "603fe95f-56ab-4ea6-8a44-2a18b8208425";
