...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    {
        public static Align GetAlign(this RadioButtonModel model)
        {
        ...
        public static bool HasAlign(this RadioButtonModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this RadioButtonModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this RadioButtonModel model)
        {
        ...
        public static bool HasFlex(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this RadioButtonModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexAuto(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this RadioButtonModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexColumns(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this RadioButtonModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexGrow(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this RadioButtonModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexInitial(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this RadioButtonModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexNone(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this RadioButtonModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexReverse(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this RadioButtonModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexRow(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this RadioButtonModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexShrink(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this RadioButtonModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this RadioButtonModel model)
        {
        ...
        public static bool HasFlexWrap(this RadioButtonModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this RadioButtonModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this RadioButtonModel model)
        {
        ...
        public static bool HasGap(this RadioButtonModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this RadioButtonModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this RadioButtonModel model)
        {
        ...
        public static bool HasGapX(this RadioButtonModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this RadioButtonModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this RadioButtonModel model)
        {
        ...
        public static bool HasGapY(this RadioButtonModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this RadioButtonModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this RadioButtonModel model)
        {
        ...
        public static bool HasGrid(this RadioButtonModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this RadioButtonModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this RadioButtonModel model)
        {
        ...
        public static bool HasGridColumnSpan(this RadioButtonModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this RadioButtonModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this RadioButtonModel model)
        {
        ...
        public static bool HasGridColumns(this RadioButtonModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this RadioButtonModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this RadioButtonModel model)
        {
        ...
        public static bool HasGridRowSpan(this RadioButtonModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this RadioButtonModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this RadioButtonModel model)
        {
        ...
        public static bool HasGridRows(this RadioButtonModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this RadioButtonModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this RadioButtonModel model)
        {
        ...
        public static bool HasJustify(this RadioButtonModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this RadioButtonModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this RadioButtonModel model)
        {
        ...
        public static bool HasOrder(this RadioButtonModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this RadioButtonModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
