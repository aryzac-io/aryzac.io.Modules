...
{
    public static class FileModelStereotypeExtensions
    {
        public static Align GetAlign(this FileModel model)
        {
        ...
        public static bool HasAlign(this FileModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this FileModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this FileModel model)
        {
        ...
        public static bool HasFlex(this FileModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this FileModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this FileModel model)
        {
        ...
        public static bool HasFlexAuto(this FileModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this FileModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this FileModel model)
        {
        ...
        public static bool HasFlexColumns(this FileModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this FileModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this FileModel model)
        {
        ...
        public static bool HasFlexGrow(this FileModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this FileModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this FileModel model)
        {
        ...
        public static bool HasFlexInitial(this FileModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this FileModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this FileModel model)
        {
        ...
        public static bool HasFlexNone(this FileModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this FileModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this FileModel model)
        {
        ...
        public static bool HasFlexReverse(this FileModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this FileModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this FileModel model)
        {
        ...
        public static bool HasFlexRow(this FileModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this FileModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this FileModel model)
        {
        ...
        public static bool HasFlexShrink(this FileModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this FileModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this FileModel model)
        {
        ...
        public static bool HasFlexWrap(this FileModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this FileModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this FileModel model)
        {
        ...
        public static bool HasGap(this FileModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this FileModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this FileModel model)
        {
        ...
        public static bool HasGapX(this FileModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this FileModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this FileModel model)
        {
        ...
        public static bool HasGapY(this FileModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this FileModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this FileModel model)
        {
        ...
        public static bool HasGrid(this FileModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this FileModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this FileModel model)
        {
        ...
        public static bool HasGridColumnSpan(this FileModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this FileModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this FileModel model)
        {
        ...
        public static bool HasGridColumns(this FileModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this FileModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this FileModel model)
        {
        ...
        public static bool HasGridRowSpan(this FileModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this FileModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this FileModel model)
        {
        ...
        public static bool HasGridRows(this FileModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this FileModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this FileModel model)
        {
        ...
        public static bool HasJustify(this FileModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this FileModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this FileModel model)
        {
        ...
        public static bool HasOrder(this FileModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this FileModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
