...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    public class LabelModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasTypeReference
    {
        public const string SpecializationType = "Label";
        public const string SpecializationTypeId = "33c12ab7-b9f4-4a5f-8c70-0ce785c138da";
