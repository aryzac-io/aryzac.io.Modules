...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    {
        public static Align GetAlign(this TextboxModel model)
        {
        ...
        public static bool HasAlign(this TextboxModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this TextboxModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this TextboxModel model)
        {
        ...
        public static bool HasFlex(this TextboxModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this TextboxModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this TextboxModel model)
        {
        ...
        public static bool HasFlexAuto(this TextboxModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this TextboxModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this TextboxModel model)
        {
        ...
        public static bool HasFlexColumns(this TextboxModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this TextboxModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this TextboxModel model)
        {
        ...
        public static bool HasFlexGrow(this TextboxModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this TextboxModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this TextboxModel model)
        {
        ...
        public static bool HasFlexInitial(this TextboxModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this TextboxModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this TextboxModel model)
        {
        ...
        public static bool HasFlexNone(this TextboxModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this TextboxModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this TextboxModel model)
        {
        ...
        public static bool HasFlexReverse(this TextboxModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this TextboxModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this TextboxModel model)
        {
        ...
        public static bool HasFlexRow(this TextboxModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this TextboxModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this TextboxModel model)
        {
        ...
        public static bool HasFlexShrink(this TextboxModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this TextboxModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this TextboxModel model)
        {
        ...
        public static bool HasFlexWrap(this TextboxModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this TextboxModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this TextboxModel model)
        {
        ...
        public static bool HasGap(this TextboxModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this TextboxModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this TextboxModel model)
        {
        ...
        public static bool HasGapX(this TextboxModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this TextboxModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this TextboxModel model)
        {
        ...
        public static bool HasGapY(this TextboxModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this TextboxModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this TextboxModel model)
        {
        ...
        public static bool HasGrid(this TextboxModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this TextboxModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this TextboxModel model)
        {
        ...
        public static bool HasGridColumnSpan(this TextboxModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this TextboxModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this TextboxModel model)
        {
        ...
        public static bool HasGridColumns(this TextboxModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this TextboxModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this TextboxModel model)
        {
        ...
        public static bool HasGridRowSpan(this TextboxModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this TextboxModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this TextboxModel model)
        {
        ...
        public static bool HasGridRows(this TextboxModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this TextboxModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this TextboxModel model)
        {
        ...
        public static bool HasJustify(this TextboxModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this TextboxModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this TextboxModel model)
        {
        ...
        public static bool HasOrder(this TextboxModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this TextboxModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
