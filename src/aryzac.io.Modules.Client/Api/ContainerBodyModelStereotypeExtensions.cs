...
{
    public static class ContainerBodyModelStereotypeExtensions
    {
        public static Align GetAlign(this ContainerBodyModel model)
        {
        ...
        public static bool HasAlign(this ContainerBodyModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this ContainerBodyModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlex(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this ContainerBodyModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexAuto(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this ContainerBodyModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexColumns(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this ContainerBodyModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexGrow(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this ContainerBodyModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexInitial(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this ContainerBodyModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexNone(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this ContainerBodyModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexReverse(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this ContainerBodyModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexRow(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this ContainerBodyModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexShrink(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this ContainerBodyModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this ContainerBodyModel model)
        {
        ...
        public static bool HasFlexWrap(this ContainerBodyModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this ContainerBodyModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this ContainerBodyModel model)
        {
        ...
        public static bool HasGap(this ContainerBodyModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this ContainerBodyModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this ContainerBodyModel model)
        {
        ...
        public static bool HasGapX(this ContainerBodyModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this ContainerBodyModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this ContainerBodyModel model)
        {
        ...
        public static bool HasGapY(this ContainerBodyModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this ContainerBodyModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this ContainerBodyModel model)
        {
        ...
        public static bool HasGrid(this ContainerBodyModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this ContainerBodyModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this ContainerBodyModel model)
        {
        ...
        public static bool HasGridColumnSpan(this ContainerBodyModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this ContainerBodyModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this ContainerBodyModel model)
        {
        ...
        public static bool HasGridColumns(this ContainerBodyModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this ContainerBodyModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this ContainerBodyModel model)
        {
        ...
        public static bool HasGridRowSpan(this ContainerBodyModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this ContainerBodyModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this ContainerBodyModel model)
        {
        ...
        public static bool HasGridRows(this ContainerBodyModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this ContainerBodyModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this ContainerBodyModel model)
        {
        ...
        public static bool HasJustify(this ContainerBodyModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this ContainerBodyModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this ContainerBodyModel model)
        {
        ...
        public static bool HasOrder(this ContainerBodyModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this ContainerBodyModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
