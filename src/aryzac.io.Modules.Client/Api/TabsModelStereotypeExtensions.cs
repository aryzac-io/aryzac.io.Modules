...
{
    public static class TabsModelStereotypeExtensions
    {
        public static Align GetAlign(this TabsModel model)
        {
        ...
        public static bool HasAlign(this TabsModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this TabsModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this TabsModel model)
        {
        ...
        public static bool HasFlex(this TabsModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this TabsModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this TabsModel model)
        {
        ...
        public static bool HasFlexAuto(this TabsModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this TabsModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this TabsModel model)
        {
        ...
        public static bool HasFlexColumns(this TabsModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this TabsModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this TabsModel model)
        {
        ...
        public static bool HasFlexGrow(this TabsModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this TabsModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this TabsModel model)
        {
        ...
        public static bool HasFlexInitial(this TabsModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this TabsModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this TabsModel model)
        {
        ...
        public static bool HasFlexNone(this TabsModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this TabsModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this TabsModel model)
        {
        ...
        public static bool HasFlexReverse(this TabsModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this TabsModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this TabsModel model)
        {
        ...
        public static bool HasFlexRow(this TabsModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this TabsModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this TabsModel model)
        {
        ...
        public static bool HasFlexShrink(this TabsModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this TabsModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this TabsModel model)
        {
        ...
        public static bool HasFlexWrap(this TabsModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this TabsModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this TabsModel model)
        {
        ...
        public static bool HasGap(this TabsModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this TabsModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this TabsModel model)
        {
        ...
        public static bool HasGapX(this TabsModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this TabsModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this TabsModel model)
        {
        ...
        public static bool HasGapY(this TabsModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this TabsModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this TabsModel model)
        {
        ...
        public static bool HasGrid(this TabsModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this TabsModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this TabsModel model)
        {
        ...
        public static bool HasGridColumnSpan(this TabsModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this TabsModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this TabsModel model)
        {
        ...
        public static bool HasGridColumns(this TabsModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this TabsModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this TabsModel model)
        {
        ...
        public static bool HasGridRowSpan(this TabsModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this TabsModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this TabsModel model)
        {
        ...
        public static bool HasGridRows(this TabsModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this TabsModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this TabsModel model)
        {
        ...
        public static bool HasJustify(this TabsModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this TabsModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this TabsModel model)
        {
        ...
        public static bool HasOrder(this TabsModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this TabsModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
