...
{
    public static class StepperModelStereotypeExtensions
    {
        public static Align GetAlign(this StepperModel model)
        {
        ...
        public static bool HasAlign(this StepperModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this StepperModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this StepperModel model)
        {
        ...
        public static bool HasFlex(this StepperModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this StepperModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this StepperModel model)
        {
        ...
        public static bool HasFlexAuto(this StepperModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this StepperModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this StepperModel model)
        {
        ...
        public static bool HasFlexColumns(this StepperModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this StepperModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this StepperModel model)
        {
        ...
        public static bool HasFlexGrow(this StepperModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this StepperModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this StepperModel model)
        {
        ...
        public static bool HasFlexInitial(this StepperModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this StepperModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this StepperModel model)
        {
        ...
        public static bool HasFlexNone(this StepperModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this StepperModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this StepperModel model)
        {
        ...
        public static bool HasFlexReverse(this StepperModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this StepperModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this StepperModel model)
        {
        ...
        public static bool HasFlexRow(this StepperModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this StepperModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this StepperModel model)
        {
        ...
        public static bool HasFlexShrink(this StepperModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this StepperModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this StepperModel model)
        {
        ...
        public static bool HasFlexWrap(this StepperModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this StepperModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this StepperModel model)
        {
        ...
        public static bool HasGap(this StepperModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this StepperModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this StepperModel model)
        {
        ...
        public static bool HasGapX(this StepperModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this StepperModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this StepperModel model)
        {
        ...
        public static bool HasGapY(this StepperModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this StepperModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this StepperModel model)
        {
        ...
        public static bool HasGrid(this StepperModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this StepperModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this StepperModel model)
        {
        ...
        public static bool HasGridColumnSpan(this StepperModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this StepperModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this StepperModel model)
        {
        ...
        public static bool HasGridColumns(this StepperModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this StepperModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this StepperModel model)
        {
        ...
        public static bool HasGridRowSpan(this StepperModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this StepperModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this StepperModel model)
        {
        ...
        public static bool HasGridRows(this StepperModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this StepperModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this StepperModel model)
        {
        ...
        public static bool HasJustify(this StepperModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this StepperModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this StepperModel model)
        {
        ...
        public static bool HasOrder(this StepperModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this StepperModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
