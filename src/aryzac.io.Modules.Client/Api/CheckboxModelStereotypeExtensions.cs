...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    {
        public static Align GetAlign(this CheckboxModel model)
        {
        ...
        public static bool HasAlign(this CheckboxModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this CheckboxModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this CheckboxModel model)
        {
        ...
        public static bool HasFlex(this CheckboxModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this CheckboxModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this CheckboxModel model)
        {
        ...
        public static bool HasFlexAuto(this CheckboxModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this CheckboxModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this CheckboxModel model)
        {
        ...
        public static bool HasFlexColumns(this CheckboxModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this CheckboxModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this CheckboxModel model)
        {
        ...
        public static bool HasFlexGrow(this CheckboxModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this CheckboxModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this CheckboxModel model)
        {
        ...
        public static bool HasFlexInitial(this CheckboxModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this CheckboxModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this CheckboxModel model)
        {
        ...
        public static bool HasFlexNone(this CheckboxModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this CheckboxModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this CheckboxModel model)
        {
        ...
        public static bool HasFlexReverse(this CheckboxModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this CheckboxModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this CheckboxModel model)
        {
        ...
        public static bool HasFlexRow(this CheckboxModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this CheckboxModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this CheckboxModel model)
        {
        ...
        public static bool HasFlexShrink(this CheckboxModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this CheckboxModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this CheckboxModel model)
        {
        ...
        public static bool HasFlexWrap(this CheckboxModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this CheckboxModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this CheckboxModel model)
        {
        ...
        public static bool HasGap(this CheckboxModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this CheckboxModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this CheckboxModel model)
        {
        ...
        public static bool HasGapX(this CheckboxModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this CheckboxModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this CheckboxModel model)
        {
        ...
        public static bool HasGapY(this CheckboxModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this CheckboxModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this CheckboxModel model)
        {
        ...
        public static bool HasGrid(this CheckboxModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this CheckboxModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this CheckboxModel model)
        {
        ...
        public static bool HasGridColumnSpan(this CheckboxModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this CheckboxModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this CheckboxModel model)
        {
        ...
        public static bool HasGridColumns(this CheckboxModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this CheckboxModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this CheckboxModel model)
        {
        ...
        public static bool HasGridRowSpan(this CheckboxModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this CheckboxModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this CheckboxModel model)
        {
        ...
        public static bool HasGridRows(this CheckboxModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this CheckboxModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this CheckboxModel model)
        {
        ...
        public static bool HasJustify(this CheckboxModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this CheckboxModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this CheckboxModel model)
        {
        ...
        public static bool HasOrder(this CheckboxModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this CheckboxModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
