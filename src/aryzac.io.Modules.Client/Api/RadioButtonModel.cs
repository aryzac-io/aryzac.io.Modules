...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    public class RadioButtonModel : IMetadataModel, IHasStereotypes, IHasName, IElementWrapper, IHasTypeReference
    {
        public const string SpecializationType = "Radio Button";
        public const string SpecializationTypeId = "6385bc35-8637-459c-a8c9-4ee68e336144";
