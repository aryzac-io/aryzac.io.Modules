...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    {
        public static Align GetAlign(this TextAreaModel model)
        {
        ...
        public static bool HasAlign(this TextAreaModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this TextAreaModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this TextAreaModel model)
        {
        ...
        public static bool HasFlex(this TextAreaModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this TextAreaModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this TextAreaModel model)
        {
        ...
        public static bool HasFlexAuto(this TextAreaModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this TextAreaModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this TextAreaModel model)
        {
        ...
        public static bool HasFlexColumns(this TextAreaModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this TextAreaModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this TextAreaModel model)
        {
        ...
        public static bool HasFlexGrow(this TextAreaModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this TextAreaModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this TextAreaModel model)
        {
        ...
        public static bool HasFlexInitial(this TextAreaModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this TextAreaModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this TextAreaModel model)
        {
        ...
        public static bool HasFlexNone(this TextAreaModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this TextAreaModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this TextAreaModel model)
        {
        ...
        public static bool HasFlexReverse(this TextAreaModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this TextAreaModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this TextAreaModel model)
        {
        ...
        public static bool HasFlexRow(this TextAreaModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this TextAreaModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this TextAreaModel model)
        {
        ...
        public static bool HasFlexShrink(this TextAreaModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this TextAreaModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this TextAreaModel model)
        {
        ...
        public static bool HasFlexWrap(this TextAreaModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this TextAreaModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this TextAreaModel model)
        {
        ...
        public static bool HasGap(this TextAreaModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this TextAreaModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this TextAreaModel model)
        {
        ...
        public static bool HasGapX(this TextAreaModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this TextAreaModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this TextAreaModel model)
        {
        ...
        public static bool HasGapY(this TextAreaModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this TextAreaModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this TextAreaModel model)
        {
        ...
        public static bool HasGrid(this TextAreaModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this TextAreaModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this TextAreaModel model)
        {
        ...
        public static bool HasGridColumnSpan(this TextAreaModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this TextAreaModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this TextAreaModel model)
        {
        ...
        public static bool HasGridColumns(this TextAreaModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this TextAreaModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this TextAreaModel model)
        {
        ...
        public static bool HasGridRowSpan(this TextAreaModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this TextAreaModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this TextAreaModel model)
        {
        ...
        public static bool HasGridRows(this TextAreaModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this TextAreaModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this TextAreaModel model)
        {
        ...
        public static bool HasJustify(this TextAreaModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this TextAreaModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this TextAreaModel model)
        {
        ...
        public static bool HasOrder(this TextAreaModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this TextAreaModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
