...
namespace Aryzac.Io.Modules.Client.Api
{
    ...
    {
        public static Align GetAlign(this ButtonModel model)
        {
        ...
        public static bool HasAlign(this ButtonModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this ButtonModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this ButtonModel model)
        {
        ...
        public static bool HasFlex(this ButtonModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this ButtonModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this ButtonModel model)
        {
        ...
        public static bool HasFlexAuto(this ButtonModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this ButtonModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this ButtonModel model)
        {
        ...
        public static bool HasFlexColumns(this ButtonModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this ButtonModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this ButtonModel model)
        {
        ...
        public static bool HasFlexGrow(this ButtonModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this ButtonModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this ButtonModel model)
        {
        ...
        public static bool HasFlexInitial(this ButtonModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this ButtonModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this ButtonModel model)
        {
        ...
        public static bool HasFlexNone(this ButtonModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this ButtonModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this ButtonModel model)
        {
        ...
        public static bool HasFlexReverse(this ButtonModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this ButtonModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this ButtonModel model)
        {
        ...
        public static bool HasFlexRow(this ButtonModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this ButtonModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this ButtonModel model)
        {
        ...
        public static bool HasFlexShrink(this ButtonModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this ButtonModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this ButtonModel model)
        {
        ...
        public static bool HasFlexWrap(this ButtonModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this ButtonModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this ButtonModel model)
        {
        ...
        public static bool HasGap(this ButtonModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this ButtonModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this ButtonModel model)
        {
        ...
        public static bool HasGapX(this ButtonModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this ButtonModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this ButtonModel model)
        {
        ...
        public static bool HasGapY(this ButtonModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this ButtonModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this ButtonModel model)
        {
        ...
        public static bool HasGrid(this ButtonModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this ButtonModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this ButtonModel model)
        {
        ...
        public static bool HasGridColumnSpan(this ButtonModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this ButtonModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this ButtonModel model)
        {
        ...
        public static bool HasGridColumns(this ButtonModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this ButtonModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this ButtonModel model)
        {
        ...
        public static bool HasGridRowSpan(this ButtonModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this ButtonModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this ButtonModel model)
        {
        ...
        public static bool HasGridRows(this ButtonModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this ButtonModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this ButtonModel model)
        {
        ...
        public static bool HasJustify(this ButtonModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this ButtonModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this ButtonModel model)
        {
        ...
        public static bool HasOrder(this ButtonModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this ButtonModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
