...
{
    public static class SliderModelStereotypeExtensions
    {
        public static Align GetAlign(this SliderModel model)
        {
        ...
        public static bool HasAlign(this SliderModel model)
        {
            return model.HasStereotype("Align");
        }

        public static bool TryGetAlign(this SliderModel model, out Align stereotype)
        {
            if (!HasAlign(model))
            {
                stereotype = null;
        ...
        public static Flex GetFlex(this SliderModel model)
        {
        ...
        public static bool HasFlex(this SliderModel model)
        {
            return model.HasStereotype("Flex");
        }

        public static bool TryGetFlex(this SliderModel model, out Flex stereotype)
        {
            if (!HasFlex(model))
            {
                stereotype = null;
        ...
        public static FlexAuto GetFlexAuto(this SliderModel model)
        {
        ...
        public static bool HasFlexAuto(this SliderModel model)
        {
            return model.HasStereotype("Flex Auto");
        }

        public static bool TryGetFlexAuto(this SliderModel model, out FlexAuto stereotype)
        {
        ...
        public static FlexColumns GetFlexColumns(this SliderModel model)
        {
        ...
        public static bool HasFlexColumns(this SliderModel model)
        {
            return model.HasStereotype("Flex Columns");
        }

        public static bool TryGetFlexColumns(this SliderModel model, out FlexColumns stereotype)
        {
        ...
        public static FlexGrow GetFlexGrow(this SliderModel model)
        {
        ...
        public static bool HasFlexGrow(this SliderModel model)
        {
            return model.HasStereotype("Flex Grow");
        }

        public static bool TryGetFlexGrow(this SliderModel model, out FlexGrow stereotype)
        {
        ...
        public static FlexInitial GetFlexInitial(this SliderModel model)
        {
        ...
        public static bool HasFlexInitial(this SliderModel model)
        {
            return model.HasStereotype("Flex Initial");
        }

        public static bool TryGetFlexInitial(this SliderModel model, out FlexInitial stereotype)
        {
        ...
        public static FlexNone GetFlexNone(this SliderModel model)
        {
        ...
        public static bool HasFlexNone(this SliderModel model)
        {
            return model.HasStereotype("Flex None");
        }

        public static bool TryGetFlexNone(this SliderModel model, out FlexNone stereotype)
        {
        ...
        public static FlexReverse GetFlexReverse(this SliderModel model)
        {
        ...
        public static bool HasFlexReverse(this SliderModel model)
        {
            return model.HasStereotype("Flex Reverse");
        }

        public static bool TryGetFlexReverse(this SliderModel model, out FlexReverse stereotype)
        {
        ...
        public static FlexRow GetFlexRow(this SliderModel model)
        {
        ...
        public static bool HasFlexRow(this SliderModel model)
        {
            return model.HasStereotype("Flex Row");
        }

        public static bool TryGetFlexRow(this SliderModel model, out FlexRow stereotype)
        {
            if (!HasFlexRow(model))
            {
                stereotype = null;
        ...
        public static FlexShrink GetFlexShrink(this SliderModel model)
        {
        ...
        public static bool HasFlexShrink(this SliderModel model)
        {
            return model.HasStereotype("Flex Shrink");
        }

        public static bool TryGetFlexShrink(this SliderModel model, out FlexShrink stereotype)
        {
        ...
        public static FlexWrap GetFlexWrap(this SliderModel model)
        {
        ...
        public static bool HasFlexWrap(this SliderModel model)
        {
            return model.HasStereotype("Flex Wrap");
        }

        public static bool TryGetFlexWrap(this SliderModel model, out FlexWrap stereotype)
        {
        ...
        public static Gap GetGap(this SliderModel model)
        {
        ...
        public static bool HasGap(this SliderModel model)
        {
            return model.HasStereotype("Gap");
        }

        public static bool TryGetGap(this SliderModel model, out Gap stereotype)
        {
            if (!HasGap(model))
            {
                stereotype = null;
        ...
        public static GapX GetGapX(this SliderModel model)
        {
        ...
        public static bool HasGapX(this SliderModel model)
        {
            return model.HasStereotype("Gap X");
        }

        public static bool TryGetGapX(this SliderModel model, out GapX stereotype)
        {
            if (!HasGapX(model))
            {
                stereotype = null;
        ...
        public static GapY GetGapY(this SliderModel model)
        {
        ...
        public static bool HasGapY(this SliderModel model)
        {
            return model.HasStereotype("Gap Y");
        }

        public static bool TryGetGapY(this SliderModel model, out GapY stereotype)
        {
            if (!HasGapY(model))
            {
                stereotype = null;
        ...
        public static Grid GetGrid(this SliderModel model)
        {
        ...
        public static bool HasGrid(this SliderModel model)
        {
            return model.HasStereotype("Grid");
        }

        public static bool TryGetGrid(this SliderModel model, out Grid stereotype)
        {
            if (!HasGrid(model))
            {
                stereotype = null;
        ...
        public static GridColumnSpan GetGridColumnSpan(this SliderModel model)
        {
        ...
        public static bool HasGridColumnSpan(this SliderModel model)
        {
            return model.HasStereotype("Grid Column Span");
        }

        public static bool TryGetGridColumnSpan(this SliderModel model, out GridColumnSpan stereotype)
        {
        ...
        public static GridColumns GetGridColumns(this SliderModel model)
        {
        ...
        public static bool HasGridColumns(this SliderModel model)
        {
            return model.HasStereotype("Grid Columns");
        }

        public static bool TryGetGridColumns(this SliderModel model, out GridColumns stereotype)
        {
        ...
        public static GridRowSpan GetGridRowSpan(this SliderModel model)
        {
        ...
        public static bool HasGridRowSpan(this SliderModel model)
        {
            return model.HasStereotype("Grid Row Span");
        }

        public static bool TryGetGridRowSpan(this SliderModel model, out GridRowSpan stereotype)
        {
        ...
        public static GridRows GetGridRows(this SliderModel model)
        {
        ...
        public static bool HasGridRows(this SliderModel model)
        {
            return model.HasStereotype("Grid Rows");
        }

        public static bool TryGetGridRows(this SliderModel model, out GridRows stereotype)
        {
        ...
        public static Justify GetJustify(this SliderModel model)
        {
        ...
        public static bool HasJustify(this SliderModel model)
        {
            return model.HasStereotype("Justify");
        }

        public static bool TryGetJustify(this SliderModel model, out Justify stereotype)
        {
            if (!HasJustify(model))
            {
                stereotype = null;
        ...
        public static Order GetOrder(this SliderModel model)
        {
        ...
        public static bool HasOrder(this SliderModel model)
        {
            return model.HasStereotype("Order");
        }

        public static bool TryGetOrder(this SliderModel model, out Order stereotype)
        {
            if (!HasOrder(model))
            {
                stereotype = null;
