...
namespace Aryzac.IO.Modules.Client.Templates.Files.Structs.Components.Props
{
    ...
    public partial class PropsTemplate : TypeScriptTemplateBase<Aryzac.IO.Modules.Client.Api.ComponentModel>, ITypescriptFileBuilderTemplate
    {
        ...
        public const string TemplateId = "Aryzac.IO.Modules.Client.Files.Structs.Components.Props";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public PropsTemplate(IOutputTarget outputTarget, Aryzac.IO.Modules.Client.Api.ComponentModel model) : base(TemplateId, outputTarget, model)
        {
