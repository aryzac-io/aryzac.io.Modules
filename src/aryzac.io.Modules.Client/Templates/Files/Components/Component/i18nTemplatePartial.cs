...
namespace Aryzac.IO.Modules.Client.Templates.Files.Components.Component
{
    ...
    partial class i18nTemplate : IntentTemplateBase<ComponentModel>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Modules.Client.Files.Components.Component";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public i18nTemplate(IOutputTarget outputTarget, ComponentModel model) : base(TemplateId, outputTarget, model)
        {
