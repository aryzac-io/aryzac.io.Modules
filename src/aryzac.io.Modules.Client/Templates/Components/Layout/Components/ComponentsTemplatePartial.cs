...
namespace Aryzac.IO.Modules.Client.Templates.Components.Layout.Components
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    partial class ComponentsTemplate : IntentTemplateBase<object>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Modules.Client.Components.Layout.Components";
