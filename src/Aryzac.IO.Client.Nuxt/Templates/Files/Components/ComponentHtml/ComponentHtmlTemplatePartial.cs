...
namespace Aryzac.IO.Client.Nuxt.Templates.Files.Components.ComponentHtml
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    partial class ComponentHtmlTemplate : HtmlTemplateBase<Aryzac.IO.Modules.Client.Api.ComponentModel>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Client.Nuxt.Files.Components.ComponentHtml";
