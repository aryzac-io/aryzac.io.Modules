...
namespace Aryzac.IO.Client.Nuxt.Templates.Files.Components.Layout.Components
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    partial class ComponentsTemplate : IntentTemplateBase<object>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Client.Nuxt.Files.Components.Layout.Components";
