...
namespace Aryzac.IO.Client.Nuxt.Templates.Files.Composables.Controls.UseLabelOptions
{
    ...
    partial class UseLabelOptionsTemplate : TypeScriptTemplateBase<Aryzac.IO.Modules.Client.Api.LabelModel>
    {
        ...
        public const string TemplateId = "Aryzac.IO.Client.Nuxt.Files.Composables.Controls.UseLabelOptions";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public UseLabelOptionsTemplate(IOutputTarget outputTarget, LabelModel model) : base(TemplateId, outputTarget, model)
        {
