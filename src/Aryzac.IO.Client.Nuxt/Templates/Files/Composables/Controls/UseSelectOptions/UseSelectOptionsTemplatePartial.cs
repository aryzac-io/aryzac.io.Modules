...
namespace Aryzac.IO.Client.Nuxt.Templates.Files.Composables.Controls.UseSelectOptions
{
    [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
    partial class UseSelectOptionsTemplate : TypeScriptTemplateBase<Aryzac.IO.Modules.Client.Api.SelectModel>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Client.Nuxt.Files.Composables.Controls.UseSelectOptions";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public UseSelectOptionsTemplate(IOutputTarget outputTarget, SelectModel model) : base(TemplateId, outputTarget, model)
        {
