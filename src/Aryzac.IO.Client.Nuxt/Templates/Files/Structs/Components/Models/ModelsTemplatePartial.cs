...
namespace Aryzac.IO.Client.Nuxt.Templates.Files.Structs.Components.Models
{
    ...
    public partial class ModelsTemplate : TypeScriptTemplateBase<Aryzac.IO.Modules.Client.Api.ComponentModel>, ITypescriptFileBuilderTemplate
    {
        ...
        public const string TemplateId = "Aryzac.IO.Client.Nuxt.Files.Structs.Components.Models";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public ModelsTemplate(IOutputTarget outputTarget, ComponentModel model) : base(TemplateId, outputTarget, model)
        {
